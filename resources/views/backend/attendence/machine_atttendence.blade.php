                                    ...
                                    <tbody class="text-center">
                                        @foreach ($data as $key => $employee)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="#" class="btn btn-primary btn-sm openModal" title="Attendance Details" data-toggle="modal" data-target="#remarkModal" data-id={{ $employee->id }}>
                                                        <i class="fa fa-list"></i>
                                                        <span>Remark</span>
                                                    </a>

                                                    <!-- Reconciliation Button -->
                                                    <a href="#" class="btn btn-primary btn-sm" title="Attendance Details" data-toggle="modal" data-target="#reconciliationModal" data-id={{ $employee->id }}>
                                                        <i class="fa fa-list"></i>
...
<div class="modal fade" id="reconciliationModal" tabindex="-1" role="dialog" aria-labelledby="reconciliationModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <input type="text" id="timeIn" class="form-control" placeholder="Time In">
                <input type="text" id="timeOut" class="form-control" placeholder="Time Out">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
